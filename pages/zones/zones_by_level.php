...
$result = db_mysql_query($query) or message_die('zones_by_level.php', 'MYSQL_QUERY', $query, $db->mysql_error());
$cpt = 0;
while ($res = $db->mysql_fetch_array($result)) {
    ...
    $result2 = db_mysql_query($query) or message_die('zones_by_level.php', 'MYSQL_QUERY', $query, $db->mysql_error());
